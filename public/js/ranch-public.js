(function () {
  ...
  function render(pack) {
    ...
    app.innerHTML =
      ...
      '<img class="av" src="' + (p.avatar || "/cowboy.svg?v=1") + '" alt="" style="width:112px;height:112px;border-radius:22px;object-fit:cover;border:4px solid #fffcf7;background:#d6dbd4">' +
